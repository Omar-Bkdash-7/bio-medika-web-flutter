...
class AppBarControllerImp extends AppBarController {
      ...
      if (response.statusRequest == StatusRequest.success) {
        ...
        await showCustomSnackbar(
          ...
          message: AppTextsEnglish
              .You_have_logged_in_to_the_site_and_you_can_now_browse_and_update_medications
              .tr,
        ...
        if (response.errors ==
            AppTextsEnglish.E_mail_or_password_is_incorrect) {
  ...
  @override
  changeLanguage() {
    Get.find<LocaleController>().changeLanguage(
  ...
  goToCategory() {
    ...
    AdminModel.get().id.isEmpty
        ? awesomeDialogLogin(Get.context!)
